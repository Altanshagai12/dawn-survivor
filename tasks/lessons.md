...
- When a leaderboard needs both ranking points and survival time, submit points as the primary score and attach `duration_ms` as metadata; render duration as an optional line beneath score instead of replacing score with time.
