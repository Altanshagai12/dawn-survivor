...
import { GameScene } from './game/GameScene.js?build=20260831a';
...
import { UIController } from './ui/UIController.js?build=20260831a';
...
async function boot() {
  ...
  if (SKIN_ACCESS_MODE === 'paid') {
    const { SkinCommerce } = await import('./commerce/SkinCommerce.js?build=20260831a');
